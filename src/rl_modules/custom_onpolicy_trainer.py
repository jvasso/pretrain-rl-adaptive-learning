...
from .custom_pg_policy import CustomPGPolicy


class CustomOnpolicyTrainer(BaseTrainer):
    ...
    def policy_update_fn(
        ...
        assert isinstance(self.policy, CustomPGPolicy) or isinstance(self.policy, PPOPolicy)
...
def custom_onpolicy_trainer(*args, **kwargs) -> Dict[str, Union[float, str]]:  # type: ignore
...
onpolicy_trainer_iter = CustomOnpolicyTrainer
